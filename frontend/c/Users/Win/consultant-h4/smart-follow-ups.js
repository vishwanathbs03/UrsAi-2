...
// features/assistant/smart-follow-ups.ts
var smart_follow_ups_exports = {};
__export(smart_follow_ups_exports, {
  buildSmartFollowUps: () => buildSmartFollowUps
});
module.exports = __toCommonJS(smart_follow_ups_exports);
var FALLBACK = [
  {
    id: "summary",
...
function buildSmartFollowUps(kind, recentTopics = []) {
