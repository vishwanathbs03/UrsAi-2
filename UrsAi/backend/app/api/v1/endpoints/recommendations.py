...
from app.schemas.recommendation import BusinessRecommendationsResponse
...
@router.get(
    "/recommendations",
    response_model=BusinessRecommendationsResponse,
    summary="Generate structured business recommendations from the rule firings",
)
def get_business_recommendations(
    ...
    return BusinessRecommendationsResponse.model_validate(payload)
